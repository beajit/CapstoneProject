...
df = pd.read_csv("/home/ajit/Documents/code/python/MachineLearning/CapstoneBankCase/Data/bank-additional/bank-additional/bank-additional-full.csv",delimiter=";")
df.shape
df.columns
df.dtypes
df.head(10)
